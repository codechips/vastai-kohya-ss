#!/usr/bin/env bash
# Shared utilities for VastAI Kohya SS services
...
function setup_workspace() {
    ...
    # Create Kohya SS directories if they don't exist
    ...
    # Note: Directory symlinks are created in kohya.sh service script
}
...
function show_info() {
    echo ""
    echo "========================================="
    echo "VastAI Kohya SS Container Started"
    echo "========================================="
    echo ""
    echo "Services:"
    echo "  - Landing Page: http://localhost:80 (service directory)"
    echo "  - Kohya SS: http://localhost:8010"
    ...
    echo "  - Kohya SS: ${WORKSPACE}/logs/kohya.log"
    ...
    echo "  - KOHYA_ARGS: ${KOHYA_ARGS:-not set}"
