...
class ProvisioningSystem:
    ...
    def __init__(self, workspace_dir: Optional[str] = None):
        ...
        self.models_dir = self.workspace_dir / "kohya_ss" / "models"
    ...
    async def _download_models(self, config: Dict) -> bool:
        ...
        for category, models in config.get("models", {}).items():
            ...
            # Handle absolute paths (like kohya_builtin)
    ...
    def _get_category_dir(self, category: str) -> str:
        """Map category to directory name for Kohya SS."""
        category_mapping = {
            # Kohya SS only needs base models for training
